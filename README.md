...
The [YubiKey PIN Generator](https://github.com/JMarkstrom/fido/raw/main/yubikey-pin-gen.py) is a Python script that facilitates configuration of a YubiKey(s). The script:
